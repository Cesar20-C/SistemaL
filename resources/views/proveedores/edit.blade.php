...
<div class="card"><div class="card-body">
  ...
  <form method="POST" action="{{ route('proveedores.update',$proveedor) }}" class="row g-3">
    ...
    <div class="col-md-6">
      ...
      <input name="nombre" class="form-control" maxlength="150"
             value="{{ old('nombre',$proveedor->nombre) }}" required>
    </div>
    <div class="col-md-6">
      <label class="form-label">Teléfono</label>
      <input name="telefono" class="form-control" maxlength="30"
             value="{{ old('telefono',$proveedor->telefono) }}">
    </div>
    <div class="col-12">
      <label class="form-label">Dirección</label>
      <input name="direccion" class="form-control" maxlength="255"
